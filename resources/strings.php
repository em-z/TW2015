...
$db = array(
	...
	"db_username" => "root",
	"db_password" => "root",
	"db_err_connect" => "An error occurred while connecting to the database. Error code: ",
	"db_users" => "users",
	"db" => "TW2015",
);
...
$Strings_FR = array(
	...
	"err_username_exist" => "Le nom d'utilisateur existe déjà.",
	"success_register" => "Enregistrement avec succés! Vous allez être redirigez vers la page d'accueil",
...
$Strings_CHS = array(
	...
	"CN" => "中文",
	"Home" => "主页",
	"err_string_null" => "必须填写所有的空格或启用Javascript",
	"err_format" => "用户名或密码格式出错",
	"err_username_exist" => "已经存在的用户名",
	"success_register" => "注册成功！即将返回来源页面。",
	"ForgetPassword" => "忘记密码",
	"Username" => "用户名",
	"Password" => "密码",
	"Nickname" => "昵称",
